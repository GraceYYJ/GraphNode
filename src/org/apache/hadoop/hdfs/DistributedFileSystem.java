...
import org.apache.hadoop.hdfs.server.namenode.Semantic;
...
public class DistributedFileSystem extends FileSystem {
  ...
  public void setTimes(Path p, long mtime, long atime
	...
	public FileStatus getFileStatusFromGraph(long pointId){
		return dfs.getFileStatusFromGraph(pointId);
	}
	public FileStatus[] getSomeFileStatusFromGraph(String[] semantic){
		return dfs.getSomeFileStatusFromGraph(semantic);
	}
	//删除元数据节点
	public void deleteFile(long pointId){
		dfs.deleteFile(pointId);
	}
