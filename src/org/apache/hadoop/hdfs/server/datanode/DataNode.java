...
public class DataNode extends Configured 
  ...
  /* add by zounan*/
  public DatanodeProtocol graphnode = null;
  ...
  // add by zounan
  private static InetSocketAddress graphNodeAddr;
  ...
  void startDataNode(Configuration conf, 
    ...
    // add by zounan
    InetSocketAddress graphNodeAddr = GraphNode.getAddress();
    ...
    /*
     *  add by zounan 
     *  connect to graphnode
     */
//    this.graphnode = (DatanodeProtocol) 
//    	      RPC.waitForProxy(DatanodeProtocol.class,
//    	                       DatanodeProtocol.versionID,
//    	                       graphNodeAddr, 
//    	                       conf);
    ...
    //add by zounan
//    DataNode.graphNodeAddr = graphNodeAddr;
...
//        graphnode.versionRequest();
    ...
    if( ! nsInfo.getBuildVersion().equals( Storage.getBuildVersion() )) {
      ...
      try {
        ...
        //add by zounan
//        graphnode.errorReport( dnRegistration,
//                DatanodeProtocol.NOTIFY, errorMsg );
      } catch( SocketTimeoutException e ) {  // namenode is busy
        LOG.info("Problem connecting to server: " + getNameNodeAddr());
      }
  ...
  private void register() throws IOException {
    ...
    while(shouldRun) {
      try {
        ...
        // add by zounan
//        graphnode.register(dnRegistration);
        break;
      } catch(SocketTimeoutException e) {  // namenode is busy
        LOG.info("Problem connecting to server: " + getNameNodeAddr());
        try {
      ...
      try {
        ...
        if (startTime - lastHeartbeat > heartBeatInterval) {
          ...
          DatanodeCommand[] cmds = namenode.sendHeartbeat(dnRegistration,
                                                       ...
                                                       getXceiverCount());
          // add by zounan
//          graphnode.sendHeartbeat(dnRegistration,
//                  data.getCapacity(),
//                  data.getDfsUsed(),
//                  data.getRemaining(),
//                  xmitsInProgress.get(),
//                  getXceiverCount());
        ...
        if (blockArray != null) {
          ...
          //add by zounan
//          graphnode.blockReceived(dnRegistration, blockArray, delHintArray);
          synchronized (receivedBlockList) {
            synchronized (delHints) {
        ...
        if (startTime - lastBlockReport > blockReportInterval) {
          ...
          // add by zounan
//          graphnode.blockReport(dnRegistration,
//                  BlockListAsLongs.convertToArrayLongs(bReport));
...
//              errStr);
    ...
    if (block.getNumBytes() > onDiskLength) {
      ...
      //add by zounan
//      graphnode.reportBadBlocks(new LocatedBlock[]{
//              new LocatedBlock(block, new DatanodeInfo[] {
//                  new DatanodeInfo(dnRegistration)})});
  ...
  private LocatedBlock syncBlock(Block block, List<BlockRecord> syncList,
    ...
    if (syncList.isEmpty()) {
      ...
      //add by zounan
//      graphnode.commitBlockSynchronization(block, 0, 0, closeFile, true,
//              DatanodeID.EMPTY_ARRAY);
      return null;
    }
    ...
    // add by zounan
//    graphnode.nextGenerationStamp(block);
    ...
    if (!successList.isEmpty()) {
      ...
      namenode.commitBlockSynchronization(block,
          ...
          nlist);
//      graphnode.commitBlockSynchronization(block,
//              newblock.getGenerationStamp(), newblock.getNumBytes(), closeFile, false,
//              nlist);
